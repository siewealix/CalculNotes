...
@dso_cache = dso_local local_unnamed_addr global [526 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 7501726849413395193, ; hash 0x681b7cd2dd4bb2f9, from name: CalculNotes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CalculNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 198
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7525750160036174640, ; hash 0x6870d5e5bd4b9b30, from name: libaot-CalculNotes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CalculNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 200
	...
	%struct.DSOCacheEntry {
		i64 7794210549837313709, ; hash 0x6c2a993317a7b6ad, from name: CalculNotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CalculNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 213
	...
	%struct.DSOCacheEntry {
		i64 8140362701030803514, ; hash 0x70f860bf41c7c83a, from name: aot-CalculNotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CalculNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 224
	...
	%struct.DSOCacheEntry {
		i64 12856479801823492300, ; hash 0xb26b644361ac78cc, from name: aot-CalculNotes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CalculNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 368
	...
	%struct.DSOCacheEntry {
		i64 14875276515074508007, ; hash 0xce6f992d88ba04e7, from name: libaot-CalculNotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CalculNotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 431
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6d915851-9945-4bdd-865e-50d4bd24241a\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.calculnotes\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [26 x i8] c"libaot-CalculNotes.dll.so\00", align 16
